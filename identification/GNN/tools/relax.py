...
def main():
    ...
    parser.add_argument('-i', '--input-pdb_gen-dir', type=str, dest='input_pdb_dir', required=True,
    ...
    for pdb_chain, mutant in mutants:
        ...
        wild_type_struct = os.path.join(input_dir, pdb_chain + ".pdb_gen")
        ...
        start_struct = os.path.join(
            output_dir, pdb_chain, pdb_chain + '_relaxed.pdb_gen')
        ...
        os.system(rosetta_relax_cmd)
        os.system('rename _relaxed_ _ * _relaxed_*.pdb_gen')
